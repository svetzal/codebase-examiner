...
def test_examine_command(runner, mock_inspect_codebase):
...
def test_examine_command_with_format_option(runner, mock_inspect_codebase):
...
def test_examine_command_with_output_file(runner, mock_inspect_codebase):
